...
لهذا الإحباط صنعت **Panel 032**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **يحوّل السمة الحاسمة في الصورة إلى بنية العلامة النصية المخصصة نفسها**.
