...
그 답답함 때문에 **Panel 032**을 만들었습니다. 템플릿을 덮는 대신 사진에서 절대 잃으면 안 될 것을 먼저 찾고, **사진의 결정적 특징을 맞춤 워드마크 자체의 구조로**로 번역합니다.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 032 예시 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 032 예시 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 032 예시 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 032 예시 8"></td>
  </tr>
</table>
